                ...
                <div className="col-span-12 md:col-span-6 p-4  border-r-0 md:border-r border-zinc-300/70">
                  ...
                  <div className="text-zinc-600 mb-4">
                    ...
                    {paymentInfo[0].paymentType === "creditCard" ? (
                      ...
                      <p className="">
                        Deberas abonar por Rapipago o Pago Fácil el valor total
                        de $<span>{totalPurchaseFormat}</span>
                      </p>
                    )}
                  </div>
                    ...
                    {shippingInfo[0].deliveryMethod === "Store" ? (
                      <div>
                        ...
                        <p className="text-zinc-600">
                          Te enviaremos un mail para notificarte cuando tu
                          pedido este listo para ser retirado
                        </p>
                      </div>
                    ) : (
                      <div>
