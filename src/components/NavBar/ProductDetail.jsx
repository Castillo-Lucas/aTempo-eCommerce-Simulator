  ...
  return (
    <div>
      {showNavBar ? (
        ...
        <div key={generarID()} className="flex border-b border-t">
          {/*Image*/}
          <div className="p-4">
          ...
          {/*Product Name and Detail*/}
          <div className="w-72 overflow-hidden px-2 pt-2">
            <p className="text-base font-medium">{brand}</p>
            <p className="text-sm  font-thin -mt-1">{product}</p>
            <div className="w-44 h-full overflow-hidden pt-1">
              <p className="text-sm font-normal">{model}</p>
          ...
          {/*Price*/}
          <div className="h-32 container mx-auto detailProduct flex  justify-around">
            {/*Price*/}
            <div className="w-20 my-auto">
              {discountPrice >= 1 ? (
                ...
                <p className="text-base text-center font-medium">${price}</p>
              )}
            </div>

            <div className="w-24 px-1 flex flex-col justify-center">
              <ItemCount
                stock={stock}
                quantity={quantity}
                currentProduct={currentProduct}
            ...
            <div className="pt-1 my-auto flex justify-center w-10">
              <svg
                width="15px"
                height="15px"
                viewBox="-6.7 0 122.88 122.88"
