      ...
      <div className="hidden md:block">
        {cardPosition === "Front" ? (
          <div className="flex justify-center relative animate__animated animate__flipInX">
            <img
              src="https://res.cloudinary.com/dthpuldpm/image/upload/v1682795618/aTempo/debitCardFront_savfui.png"
              alt=""
              className="h-72"
            />
          ...
          <div className="flex justify-center relative animate__animated animate__jackInTheBox">
            <img
              src="https://res.cloudinary.com/dthpuldpm/image/upload/v1682795617/aTempo/debitCardBack_swgoka.png"
              alt=""
              className="h-72"
            />
